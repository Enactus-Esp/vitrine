    ...
    return (<>
        <div className="bg-white pb-6 sm:pb-8 lg:pb-12">
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    ...
                    <div className="flex item-center justify-center mx-auto max-w-screen-md px-4 md:px-8 mb-[50px]">
                        <h1 className="text-black-800 mb-8 text-4xl font-bold sm:text-5xl md:mb-12 md:text-6xl">D I M B A L I</h1>
